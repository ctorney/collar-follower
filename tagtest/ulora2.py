...
#        gpio_interrupt = Pin(self._interrupt, Pin.IN, Pin.PULL_DOWN)
        ...
        #print(self._spi_read(REG_01_OP_MODE))
        #print(self._read_into(REG_01_OP_MODE, self._BUFFER, length=1))
        #self.set_mode_idle()
    ...
    def _read_into(self, address, buf, length=None):
        ...
        if length is None:
            length = len(buf)
        with self._device as device:
            #self._BUFFER[0] = address | 0x80  # Strip out top bit to set 0
