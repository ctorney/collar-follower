...
240    _RADTXPWR = 10
1000   _RADIO = 2
1010   PRINT "Sending out a ping.. I hope someone is out there.."
...
1080   _RADIO = 0
1085   PRINT "Doesn't seem like anyone is there so I'm having a snooze..."
...
2050     IF CLOCK MOD pinginterval = 0 THEN _RADMSG$ = "PINGPONG" 
